...
CONNECTORS = {
    ...
    "reed": {
        ...
        "note": "Needs the reed-mcp server (Python). Until it's published, clone/point at the server path.",
    },
    "adzuna": {
        ...
        "note": "Needs the adzuna-mcp server (Python). Until published, clone/point at the server path.",
    },
}
