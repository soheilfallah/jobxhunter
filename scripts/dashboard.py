...
STATUS_COLOR = {
    "Drafted": "#8b949e", "Cold-emailed": "#a371f7", "Replied": "#38bdf8",
    "Applied": "#2ea043", "Interview": "#3b82f6", "Interviewed": "#3b82f6",
    "Offer": "#d4a017", "Rejected": "#e5534b", "Skipped": "#6e7681",
    "Not applied": "#6e7681",
}
BRAND = "#7c5cff"
...
def _scores(d):
    ...
    bars = "".join(_bar(labels[i], buckets[i], maxv,
                        "#2ea043" if i >= 3 else "#3b82f6" if i == 2 else "#8b949e")
                   for i in range(5))
...
CSS = """
:root{--bg:#f6f7f9;--card:#ffffff;--ink:#1c2128;--ink2:#57606a;--muted:#8b949e;
--line:#e5e8eb;--track:#eef0f2;--brand:#7c5cff}
@media (prefers-color-scheme:dark){:root{--bg:#0d1117;--card:#161b22;--ink:#e6edf3;
--ink2:#adbac7;--muted:#768390;--line:#21262d;--track:#21262d}}
